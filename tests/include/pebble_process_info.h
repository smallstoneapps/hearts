...
#define PROCESS_INFO_CURRENT_SDK_VERSION_MINOR 0x35

// The first SDK to ship with 3.0 APIs
#define PROCESS_INFO_FIRST_3_0_SDK_VERSION_MAJOR 0x5
#define PROCESS_INFO_FIRST_3_0_SDK_VERSION_MINOR 0x16
